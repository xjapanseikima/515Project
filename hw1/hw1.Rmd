...
```{r PLD}
library(quantmod)
data.PLD <- read.csv("/Users/ALEX/Documents/workspace_R/515/dataset/PLD.csv",header=TRUE)
head(data.PLD) 
class(data.PLD$Date) 
...
```{r ET}
library(quantmod)
data.ET <- read.csv("/Users/ALEX/Documents/workspace_R/515/dataset/ET.csv",header=TRUE)
head(data.ET) 
class(data.ET$Date) 
...
Total.Five <- subset(Total.bb, Date > as.Date('2007-01-01'))
